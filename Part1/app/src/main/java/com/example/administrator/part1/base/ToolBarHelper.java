...
public class ToolBarHelper {
    ...
    * */
    ...
    public ToolBarHelper(Context context, int layoutId, int rootViewId) {
    ...
    private void initToolBar() {
        ...
        toolbar = mInflater.inflate(R.layout.toolbar, mContentView);
...
//        toolbar.setLayoutParams(params);
    ...
    private void initToolBar(int rootViewId) {
        /*通过inflater获取toolbar的布局文件*/
        toolbar = mInflater.inflate(rootViewId, mContentView);
        mToolBar = (Toolbar) toolbar.findViewById(R.id.id_tool_bar);
//        Toolbar.LayoutParams params = new Toolbar.LayoutParams(
//                Toolbar.LayoutParams.WRAP_CONTENT,
//                Toolbar.LayoutParams.WRAP_CONTENT,
